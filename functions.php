...
add_action('ba_footer', function() {
    echo '<p id="copyright">© 2015-2017 Textes, design et développement <nobr><a
href="http://matthieu.bovel.net" rel="author">Matthieu Bovel</a></nobr>, tous droits réservés.</p>';
});
